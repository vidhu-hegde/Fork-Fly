...
async function handleSearchRequest(input) {
...
async function searchMemories({ destination, platforms, budget, focus, recency }) {
...
async function buildGuideWithClaude({
  ...
  return normalizeGuide(parsed, destination);
}
